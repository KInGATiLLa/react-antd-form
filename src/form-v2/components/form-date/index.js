...
import { Form, DatePicker, TimePicker, Icon } from 'antd';
...
Common
  ...
  open : boolean
  picker: date|week|month|year | 'date'
...
RangePicker
  ...
  separator : 	string | '~'
  showTime : object|boolean | 	TimePicker Options
  showTime.defaultValue : moment[] | [moment(), moment()]
  value : [moment, moment]
  ...
  getProps(config) {
    ...
    switch (specificType) {
      case 'datetime':
        ...
        break;
      case 'range':
        props = { ...props, allowEmpty, onChange: this.rangeOnChange, showTime: hasTime || false };
        break;
      case 'time':
        props = {
          ...props,
          clearIcon: renderIcon(clearIcon),
        };
        break;
      default:
        props = { ...props };
